...
class VolcEngineAsr(
    ...
    override fun open(lang: String, callback: AsrCallback): AsrStream = VolcStream(callback)

    private inner class VolcStream(private val cb: AsrCallback) : AsrStream {
        ...
        private inner class Listener : WebSocketListener() {
            override fun onOpen(ws: WebSocket, response: Response) {
                ...
                synchronized(lock) {
                    ...
                    ws.send(VolcFrame.buildFullClientRequest(requestJson().toByteArray()).toByteString())
    ...
    private fun requestJson(): String = JSONObject().apply {
